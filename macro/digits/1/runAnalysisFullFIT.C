...
*/
  ...
  */
  TH2F *hTimePerCh_FDD = new TH2F("hTimePerCh_FDD","Time per chID, FDD;chID;Time",sNchannelsFDD,0,sNchannelsFDD,4000,-2000,2000);
  listOutput->Add(hTimePerCh_FDD);

  TH2F *hNchannels_FDD = new TH2F("hNchannels_FDD","Number of channels A vs C, FDD;sideA;sideC",16,0,16,16,0,16);
  listOutput->Add(hNchannels_FDD);
...
//        chDataParamsFDD_noCut.print();
    ...
    //      hCollisionTimeVsVertexFDD_noCut->Fill(chDataParamsFDD.mVrtPos,chDataParamsFDD.mCollTime);
        }
        */
        if(chDataParamsFDD_noCut.mIsReadyAC) {
        ...
        hNchannels_FDD->Fill(chDataParamsFDD_noCut.mNchanA,chDataParamsFDD_noCut.mNchanC);
//        hNchannels_FDD->Fill(nA,nC);
/*
        if(nA>0&&nC>0) {
          hCollisionTimeVsVertexFDD_noCut->Fill((timeC-timeA)/2* sNSperTimeChannel * sNS2Cm,(timeC+timeA)/2* sNSperTimeChannel);
        }
*/
        if(isSpotFT0_1) {
