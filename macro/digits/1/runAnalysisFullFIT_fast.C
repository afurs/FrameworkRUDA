...
/*
  ...
  */
  ...
  //FT0
  TH2F *hAmpFT0A_TS = new TH2F("hAmpFT0A_TS","Timeseries vs amplitude FT0A;[TFID];Amp [ADC]",sNsizeTS_bins,0,N_TS_MAX,4100,-100,4000);
  listOutputFT0->Add(hAmpFT0A_TS);
  TH2F *hAmpFT0C_TS = new TH2F("hAmpFT0C_TS","Timeseries vs amplitude FT0C;[TFID];Amp [ADC]",sNsizeTS_bins,0,N_TS_MAX,4100,-100,4000);
  ...
  //FV0
  TH2F *hAmpFV0A_TS = new TH2F("hAmpFV0A_TS","Timeseries vs amplitude FV0A;[TFID];Amp [ADC]",sNsizeTS_bins,0,N_TS_MAX,4100,-100,4000);
  ...
  //FDD
  TH2F *hAmpFDDA_TS = new TH2F("hAmpFDDA_TS","Timeseries vs amplitude FDDA;[TFID];Amp [ADC]",sNsizeTS_bins,0,N_TS_MAX,4100,-100,4000);
  listOutputFDD->Add(hAmpFDDA_TS);
  TH2F *hAmpFDDC_TS = new TH2F("hAmpFDDC_TS","Timeseries vs amplitude FDDC;[TFID];Amp [ADC]",sNsizeTS_bins,0,N_TS_MAX,4100,-100,4000);
...
*/
      ...
      for(const auto &entry: syncMap) {
        ...
        const std::size_t TFID = (orbit-459000000-68259840) / sOrbitPerTF;
