...
cmake -S ${PATH_TO_SRC} -B ${PATH_TO_BUILD} -DCMAKE_INSTALL_PREFIX=$PATH_TO_INSTALL -DPATH_TO_GRIDRUDA=$PATH_TO_GRIDRUDA -DPATH_TO_LOCAL_LOGBOOK=$PATH_TO_LOCAL_LOGBOO
