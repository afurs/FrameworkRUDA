...
COMMAND_FILEPTHS="alien_find -l ${N_FILES} -f ${FULL_PATH_TO_RAW} _rawtf_ | sed 's/^/alien:\/\//'  > ${INPUT_FILELIST}"
COMMAND_CTF2DIGITS="o2-raw-tf-reader-workflow --input-data ${INPUT_FILELIST} --onlyDet FDD,FT0,FV0 -b "
COMMAND_CTF2DIGITS+=" | o2-fdd-digits-writer-workflow --disable-mc -b --outfile o2_d1_digits_${RUNNUM}.root"
COMMAND_CTF2DIGITS+=" | o2-ft0-digits-writer-workflow --disable-mc -b --outfile o2_d2_digits_${RUNNUM}.root"
COMMAND_CTF2DIGITS+=" | o2-fv0-digits-writer-workflow --disable-mc -b --outfile o2_d3_digits_${RUNNUM}.root"
