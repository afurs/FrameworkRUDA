...
//=========================================================================
  const std::string filepathOutput="tableCalibOffsets_calib_run523144.csv";
...
*/
  auto dynTable = common::DynamicTable(getRunnum, getValue64Bit,getGausPeakVector,getMeanVector,getIntegralVector);
...
//================================================================
      ...
      dynTable.setCurrentArg<4>(vecHistsTime);
